...
v1_patterns = [
    ...
    path(r'group', views.WorkflowGroup.as_view({"get": "list", "post": "create"}), name='v1.workflow.group'),
    ...
    path(r'template/<int:pk>/state', views.WorkflowState.as_view({"get": "retrieve"}), name='v1.workflow.state'),
    path(r'state', views.WorkflowState.as_view({"post": "create"}), name='v1.workflow.state.new'),
    path(r'state/<int:pk>', views.WorkflowState.as_view({"put": "update", "delete": "destroy"}),
         name='v1.workflow.state.detail'),
    path(r'template/<int:pk>/transition', views.WorkflowTransition.as_view({"get": "retrieve"}), name='v1.workflow.transition'),
    path(r'transition', views.WorkflowTransition.as_view({"post": "create"}), name='v1.workflow.transition.new'),
    ...
    path(r'ticket/new', views.TicketFlowNew.as_view(), name='v1.workflow.ticketflow.new'),
    path(r'ticket/<int:pk>/detail', views.TicketFlowDetail.as_view(), name='v1.workflow.ticketflow.detail'),
