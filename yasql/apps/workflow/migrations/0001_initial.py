# Generated by Django 2.2.16 on 2021-04-02 04:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state_type', models.IntegerField(choices=[(0, '普通类型'), (1, '初始状态'), (2, '结束状态')], default=0, help_text='初始状态:新建工单时,获取对应的字段必填及transition信息，结束状态：此状态下的工单不得再处理，即没有对应的transition', verbose_name='状态类型id')),
                ('participant_type', models.IntegerField(choices=[(1, '个人'), (2, '多人'), (3, '部门'), (4, '角色'), (5, 'oncall'), (6, '机器人'), (7, '工单的字段'), (8, 'hook')], default=1, verbose_name='操作人类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('limit_expression', models.CharField(default='{}', max_length=2048, verbose_name='限制表达式')),
                ('display_form', models.CharField(default='[]', max_length=1024, verbose_name='可见表单字段,自定义字段中的field_key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_type', models.CharField(choices=[('string', '字符串'), ('integer', '整型'), ('boolean', '布尔'), ('textarea', '文本框'), ('select', '单选下拉列表'), ('multiselect', '多选下拉列表'), ('file', '附件'), ('user', '用户')], max_length=32, verbose_name='类型')),
                ...
                ('description', models.CharField(blank=True, help_text='字段的描述信息，可用于显示在字段的下方对该字段的详细描述', max_length=128, null=True, verbose_name='字段描述')),
                ('placeholder', models.CharField(blank=True, help_text='用户工单详情表单中作为字段的占位符显示', max_length=128, null=True, verbose_name='占位符')),
                ('field_value', models.TextField(blank=True, help_text='bool/radio/checkbox/select/multiselect提供选项，格式为json如:{"1":"需要","0":"不需要"},{"1":"中国", "2":"美国"}', null=True, verbose_name='radio、checkbox、select的选项')),
                ('workflow', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='wf_custom_field', to='workflow.WorkflowTpl', verbose_name='关联流程')),
            ],
            options={
                'verbose_name': '流程字段',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transition_type', models.IntegerField(choices=[(1, '常规流转'), (2, '其他')], help_text='1.常规流转，2.其他', verbose_name='流转类型')),
                ('condition_expression', models.CharField(default='[]', help_text='流转条件表达式，根据表达式中的条件来确定流转的下个状态', max_length=2048, verbose_name='条件表达式')),
                ('attribute_type', models.IntegerField(default=1, help_text='1.同意，2.拒绝，3.超时，4.其他', verbose_name='属性类型')),
                ('field_require_check', models.BooleanField(default=True, help_text='提交数据时需要校验工单表单的必填项。如"退回"属性的操作，不需要填写表单内容', verbose_name='是否校验必填项')),
                ('destination_state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='state_destination', to='workflow.State', verbose_name='目的状态')),
